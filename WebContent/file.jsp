...
<body>
	...
	<form action="manager.jsp" method="post">
		<table border="0" cellspacing="0" cellpadding="0" align="center">
			...
			<tr>
				<td>创建/删除:</td>
				<td><input type="radio" name="createDel" id="createDel" value="create" />创建&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="createDel" id="createDel" value="del" />删除 </td>
			</tr>
			<tr>
				<td>目录/文件:</td>
				<td><input type="radio" name="dirFile" id="dirFile" value="dir" />目录&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="dirFile" id="dirFile" value="file" />文件</td>
			</tr>
			<tr>
				<td><input type="submit" name="input" id="input" value="提交" /></td>
